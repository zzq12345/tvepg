...
$post31 = "contentPk=MOD_LIVE_0000000" . $cid3[$idm3 - 1][0] . "&date=" . $dt12;
 ...
 $trm31= count($um31);
//print  $trm31;
//$chn.="<programme start=\"".date("YmdHis",$un31[$trm3-1][1]).' +0800'."\" stop=\"".date("YmdHis", $un31[0][1]).' +0800'."\" channel=\"" . $cid3[$idm3 - 1][1] . "\">\n<title lang=\"zh\">". $um3[$trm3-1][1]."</title>\n<desc lang=\"zh\"> </desc>\n</programme>\n";

for ($k31 = 1; $k31 <= $trm31; $k31++) {
...
array('164','TaiwanPlus有線'),
array('168','LOVE NATURE有線'),
array('200','CI罪案偵查頻道有線'),
array('201','lifetime娛樂頻道有線'),
array('202','Asian Food Network 亞洲美食頻道'),
array('203','梅迪奇藝術頻道有線'),
array('204','Discovery Asia有線'),
array('205','Discovery科學頻道有線'),
array('206','DMAX有線'),
array('207','EVE有線'),
array('209','博斯運動一台有線'),
array('211','HITS有線'),
array('212','History 歷史頻道有線'),
array('213','PET CLUB TV寵物頻道有線'),
array('214','滾動力 rollor有線'),
array('215','cinemalworld世界電影頻道有線'),
array('216','My Cinema Europe HD 我的歐洲電影有線'),
array('217','HBO HD'),
array('218','HBO Signature 原創鉅獻'),
array('219','HBO Hits 強檔鉅獻'),
array('220','HBO Family'),
array('221','tvN有線'),
array('222','華藝MBC綜合台有線'),
array('223','靖天映畫有線'),
array('224','靖天電影有線'),
...
if( (str_replace(':','',$beginTime41))<(str_replace(':','',$endTime41))){
   ...
   $chn .= "<programme start=\"" . $dt1.str_replace(':', '', str_replace('-', '', str_replace(' ', '', str_replace('.0', '', $beginTime41)))) . "00 +0800\" stop=\"" .$dt2. str_replace(':', '', str_replace('-', '', str_replace(' ', '', str_replace('.0', '', $endTime41)))) . "00 +0800\"  channel=\"".$cid4[$idm4-1][1]."\">\n<title lang=\"zh\">" . $name41 . "</title>\n<desc lang=\"zh\"> " . $description41 . "</desc>\n</programme>\n";
...
if( (str_replace(':','',$beginTime412))<(str_replace(':','',$endTime412))){
...
$chn .= "<programme start=\"" . $dt2.str_replace(':', '', str_replace('-', '', str_replace(' ', '', str_replace('.0', '', $beginTime412)))) . "00 +0800\" stop=\"" .$dt21. str_replace(':', '', str_replace('-', '', str_replace(' ', '', str_replace('.0', '', $endTime412)))) . "00 +0800\"  channel=\"".$cid4[$idm4-1][1]."\">\n<title lang=\"zh\">" . $name412 . "</title>\n<desc lang=\"zh\"> " . $description41 . "</desc>\n</programme>\n";
...
array('2089','Hami體育1台'),
array('2091','Hami體育2台'),
array('2090','Hami體育2台(免費)'),
array('1981','HBLTV1台'),
array('2062','HBLTV1台(免費)'),
array('1982','HBLTV2台'),
array('2063','HBLTV2台(免費)'),
array('1901','HGTV居家樂活頻道'),
array('1859','History'),
array('2056','INULTRA'),
array('1892','KKBOX風雲榜C位視角'),
array('1891','KKBOX風雲榜主視角'),
array('1894','KKBOX風雲榜應援視角'),
array('1893','KKBOX風雲榜追星視角'),
array('1970','Lifetime'),
...
$url651='https://www.ofiii.com/channel/watch/4gtv-4gtv156';
 $ch651=curl_init();
curl_setopt($ch651,CURLOPT_URL,$url651);
curl_setopt($ch651,CURLOPT_SSL_VERIFYPEER,false);
curl_setopt($ch651,CURLOPT_SSL_VERIFYHOST,false);
curl_setopt($ch651,CURLOPT_RETURNTRANSFER,1);
$headers651=[
...
curl_setopt($ch651, CURLOPT_HTTPHEADER, $headers651);
$re651=curl_exec($ch651);
//$re651=str_replace('&','',$re650);
curl_close($ch651);
preg_match('/"buildId":"(.*)",/i',$re651,$yuu651);
$id650=650081;//起始节目编号
$cid650=array(
...
//print  $yuu651[1];
for ($idm650=1; $idm650 <= $nid650; $idm650++){
   $url650='https://www.ofiii.com/_next/data/'.$yuu651[1].'/channel/watch/'.$cid650[$idm650-1][0].'.json?contentId='.$cid650[$idm650-1][0];
  $idd650=$id650+$idm650;
 $ch650=curl_init();
...
$time17=microtime(true)*10000;
  $url17='https://www.olympics.com/zh/api/v1/live/video/'.$dt11.'/octv/epglist?channelid=OCTV';
          //https://www.olympics.com/zh/api/v1/live/video/2025-04-18/octv/epglist?channelid=OCTV
    $ch17 = curl_init();
...
//Cookie: AKA_A2=A; ak_bmsc=32C57BD0C1EA0844EE872CF7F5873D6D~000000000000000000000000000000~; OptanonAlertBoxClosed=2025-04-17T07:10:10.674Z; gig_bootstrap_3_0-C5fmAFNYLmRECBReEdIiy3GrU6r29UMMqR5ej2AF3EiMrp2XiSJ-W3qWQ76Bsf=olympicid_ver4; bm_mi=4A416710B62E70E4F8857E8D04A60542~~1; OptanonConsent=isGpcEnabled=0&datestamp=Thu+Apr+17+2025+15%3A14%3A01+GMT%2B0800+(%E5%8F%B0%E5%8C%97%E6%A8%99%E6%BA%96%E6%99%82%E9%96%93)&version=202411.2.0&browserGpcFlag=0&isIABGlobal=false&hosts=&genVendors=&consentId=29917f7c-b06e-4872-b658-473c6bcbb32e&interactionCount=1&isAnonUser=1&landingPath=NotLandingPage&groups=C0001%3A1%2CC0002%3A1%2CC0003%3A1%2CC0004%3A1%2CC0005%3A1&intType=1&geolocation=TW%3BKHH&AwaitingReconsent=false; bm_sv=D67D9844A5AEF2E3C706A362C6D53247~~1
];
curl_setopt($ch17, CURLOPT_HTTPHEADER, $hea17);
 $re17 = curl_exec($ch17);
  $re17= str_replace('&', '&amp;', $re17);
    curl_close($ch17);
...
$url171='https://www.olympics.com/zh/api/v1/live/video/'.$dt12.'/octv/epglist?channelid=OCTV';
          //https://www.olympics.com/zh/api/v1/live/video/2025-04-18/octv/epglist?channelid=OCTV
    $ch171 = curl_init();
    curl_setopt($ch171, CURLOPT_URL, $url171);
    curl_setopt($ch171, CURLOPT_RETURNTRANSFER, 1);
    curl_setopt($ch171, CURLOPT_SSL_VERIFYPEER, FALSE);
    curl_setopt($ch171, CURLOPT_SSL_VERIFYHOST, FALSE);
curl_setopt($ch171, CURLOPT_HTTPHEADER, $hea17);
 $re171 = curl_exec($ch171);
  $re171= str_replace('&', '&amp;', $re171);
    curl_close($ch171);
  // $re17=compress_html($re17);
//print $re17;
preg_match_all('|"startTime":"(.*?)"|i',$re171,$us171,PREG_SET_ORDER);//播放开始時間
preg_match_all('|"endTime":"(.*?)"|i',$re171,$ue171,PREG_SET_ORDER);//播放结束時間
preg_match_all('|"title":"(.*?)",|i',$re171,$um171,PREG_SET_ORDER);//播放節目
$trm171=count($us171);
//print_r( $us17);
//print_r( $ue17);
//print_r( $um17);

for ($k171 = 1; $k171 <= $trm171-1 ; $k171++) {  
       $chn.="<programme start=\"".str_replace('T','',str_replace('-','',str_replace(':','',$us171[$k171-1][1]))).' +0000'."\" stop=\"".str_replace('T','',str_replace('-','',str_replace(':','',$us171[$k171][1]))).' +0000'."\" channel=\"奥林匹克官网直播\">\n<title lang=\"zh\">".str_replace('|','',str_replace( '-','',$um171))[($k171-1)*2][1]."</title>\n<desc lang=\"zh\"> </desc>\n</programme>\n";
                                                                                           }   
  $chn.="<programme start=\"".str_replace('T','',str_replace('-','',str_replace(':','',$us171[ $trm171-1][1]))).' +0000'."\" stop=\"".str_replace('T','',str_replace('-','',str_replace(':','',$ue171[ $trm171-1][1]))).' +0000'."\" channel=\"奥林匹克官网直播\">\n<title lang=\"zh\">".str_replace('|','',str_replace( '-','',$um171))[($trm171-1)*2][1]."</title>\n<desc lang=\"zh\"> </desc>\n</programme>\n";
...
for ($idm600= 1; $idm600 <= $nid600; $idm600++){
 $idd600=$id600+$idm600;
   $url600='https://www.ebs.co.kr/schedule?channelCd='.$cid600[$idm600-1][0].'&date='.$dt1;
                 //https://www.ebs.co.kr/schedule?channelCd=tv2&onor=tv2&date=20250413
$ch600=curl_init();
...
$headers600=[
'User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36 Edg/114.0.1823.86',
'Referer: Referer: https://www.ebs.co.kr/schedule?channelCd='.$cid600[$idm600-1][0].'&onor='.$cid600[$idm600-1][0],
//'Cookie: WHATAP=zq1p9og4vtfru; XTVID=A230717100728270943; PCID=16895596508411605420033; ONAIR_MODE=DEFAULT; SESSION=502b96e9-e81f-4235-b8db-49a23eb3d60e; ONAIR_RATING=1689661221687:257c4cda

];
curl_setopt($ch600, CURLOPT_HTTPHEADER, $headers600);
$re600=curl_exec($ch600);
$re600=str_replace('&','',$re600);
$re600=str_replace('월','',$re600);
$re600=str_replace('월','',$re600);
curl_close($ch600);
...
for ( $i600=0 ; $i600<=$tuu600-2 ; $i600++ ) {
$chn.="<programme start=\"".$dt7.substr(str_replace('-','',str_replace(':','',$StartTime600[$i600][1])),0,4).substr(str_replace('-','',str_replace(':','',$StartTime600[$i600][1])),-4,4).'00 +0700'."\" stop=\"".$dt7.substr(str_replace('-','',str_replace(':','',$StartTime600[$i600][1])),0,4).substr(str_replace('-','',str_replace(':','',$StartTime600[$i600+1][1])),-4,4).'00 +0700'."\" channel=\"".$cid600[$idm600-1][1]."\">\n<title lang=\"zh\">".$Title600[$i600][1]."</title>\n<desc lang=\"zh\">".$abtr600[$i600][1]."</desc>\n</programme>\n";
}
 $url601='https://www.ebs.co.kr/schedule?channelCd='.$cid600[$idm600-1][0].'&date='.$dt2;
$ch601=curl_init();
...
$chn.="<programme start=\"".$dt7.substr(str_replace('-','',str_replace(':','',$StartTime600[$tuu600-1][1])),0,4).substr(str_replace('-','',str_replace(':','',$StartTime600[$tuu600-1][1])),-4,4).'00 +0700'."\" stop=\"".$dt7.substr(str_replace('-','',str_replace(':','',$StartTime601[0][1])),0,4).substr(str_replace('-','',str_replace(':','',$StartTime601[0][1])),-4,4).'00 +0700'."\" channel=\"".$cid600[$idm600-1][1]."\">\n<title lang=\"zh\">".$Title600[$tuu600-1][1]."</title>\n<desc lang=\"zh\">".$abtr600[$i600][1]."</desc>\n</programme>\n";
for ( $i601=0 ; $i601<=$tuu601-2 ; $i601++ ) {
$chn.="<programme start=\"".$dt7.substr(str_replace('-','',str_replace(':','',$StartTime601[$i601][1])),0,4).substr(str_replace('-','',str_replace(':','',$StartTime601[$i601][1])),-4,4).'00 +0700'."\" stop=\"".$dt7.substr(str_replace('-','',str_replace(':','',$StartTime601[$i601][1])),0,4).substr(str_replace('-','',str_replace(':','',$StartTime601[$i601+1][1])),-4,4).'00 +0700'."\" channel=\"".$cid600[$idm600-1][1]."\">\n<title lang=\"zh\">".$Title601[$i601][1]."</title>\n<desc lang=\"zh\">".$abtr601[$i601][1]."</desc>\n</programme>\n";
}
}
 $chn.="</tv>\n";
//print  $chn;
