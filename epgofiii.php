...
$id650=650081;//起始节目编号
$cid650=array(
array('4gtv-4gtv066','臺視'),
array('4gtv-4gtv040','中視'),
array('4gtv-4gtv041','華視'),
array('4gtv-4gtv076','亞洲旅遊臺'),
array('litv-ftv17','好消息2臺'),
array('litv-ftv16','好消息'),
array('litv-longturn20','ELTV生活英語臺'),
array('litv-longturn01','龍華卡通臺'),
array('litv-longturn19','Smart知識臺'),
array('litv-longturn18','龍華戲劇臺'),
array('litv-longturn22','臺灣戲劇臺'),
array('4gtv-4gtv102','東森購物1臺'),
array('litv-longturn12','龍華偶像臺'),
array('litv-longturn11','龍華日韓臺'),
array('4gtv-4gtv052','華視新聞'),
array('4gtv-4gtv103','東森購物2臺'),
array('4gtv-4gtv158','寰宇財經臺'),
array('4gtv-4gtv051','臺視新聞'),
array('4gtv-4gtv074','中視新聞'),
array('4gtv-4gtv009','中天新聞臺'),
array('4gtv-4gtv156','寰宇新聞臺灣臺'),
array('litv-longturn14','寰宇新聞臺'),
array('4gtv-4gtv104','第1商業臺'),
array('4gtv-4gtv084','國會頻道1臺'),
array('4gtv-4gtv085','國會頻道2臺'),
array('litv-longturn21','龍華經典臺'),
array('litv-longturn03','龍華電影臺'),
array('litv-longturn02','龍華洋片臺'),
);
...
/*
    ...
    array('ofiii22', '哆啦A梦(中文)'),

    array('ofiii23', '哆啦A梦中文版'),
    ...
    array('ofiii50', '掏掏新聞'),
    array('ofiii51', '柯文哲政治風波'),
    array('ofiii52', '倪珍新聞'),
    array('ofiii55', '國際大小事'),
    array('ofiii56', '全國大罷免'),
    array('ofiii64', '第1財經'),
    array('ofiii70', 'Golden強片臺'),
    array('ofiii73', '周星馳臺'),
    array('ofiii74', '歐飛電影臺'),
    array('ofiii75', '歐飛動作電影臺'),
    array('nnews-vn', '倪珍睡前新聞'),
    ...
    array('ofiii161', 'WIND BREAKER - 防風少年 -'),
    array('ofiii162', '在異世界獲得超能力的我，在現實世界照樣無敵~等級提升改變人生命運~'),
    array('ofiii163', '第一神拳'),
    array('ofiii164', '刀劍神域(中文版)'),
    array('ofiii165', '龜筆小新(中文版)'),
    ...
    array('ofiii175', '家庭教師HITMAN REBORN!(中文版)'),
    array('ofiii176', '烘焙王(中文版)'),
    array('ofiii177', '鋼之鍊金術師'),
    array('ofiii178', 'JOJO 的奇妙冒險'),
    array('ofiii179', '葬送的芙莉蓮'),
    array('ofiii180', '史上最強弟子 一(中文版)'),
    array('ofiii181', '爆漫王(中文版)'),
    ...
    array('ofiii229', '食尚玩家 - 魚肉鄉民'),
    array('ofiii230', '食尚玩家 - 瘋狂總部'),
